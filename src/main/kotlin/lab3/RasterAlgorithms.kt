...
class RasterAlgorithms : Application() {
    ...
    class DemoScene(override val primaryStage: Stage): SceneWrapper(primaryStage, "Graphics task") {
        init {
            ...
            val imgFile = Image(FileInputStream("assets/start.png"))
            gc.drawImage(imgFile, 0.0, 0.0, 800.0, 600.0);
        }
    }
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            launch(RasterAlgorithms::class.java, *args)
        }
    }
}
